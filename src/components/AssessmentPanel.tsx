...
const AssessmentPanel = () => {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-[6px] gradient-card-dark p-6 text-primary-foreground relative overflow-hidden">
      ...
      <motion.button
        ...
        className="w-full mt-4 py-4 rounded-[6px] bg-foreground text-background font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg"
      >
        Acessar Avaliações
